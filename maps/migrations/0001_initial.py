    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pipe_coordinates', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(max_length=255), size=None), size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('zone_title', models.CharField(blank=True, max_length=100)),
                ('zone_description', models.TextField(blank=True)),
                ('zone_num', models.IntegerField(default=0)),
                ('zone_date', models.DateTimeField(default=datetime.datetime.now)),
                ('zone_status', models.CharField(choices=[('notStart', 'Not Started'), ('Pending', 'Pending'), ('Completed', 'Completed')], default='notStart', max_length=20)),
                ('zone_color', models.CharField(choices=[('green', 'green'), ('orange', 'orange'), ('red', 'red')], default='orange', max_length=20)),
                ('zone_area', models.FloatField(default=0)),
                ('zone_coordinates', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(max_length=255), size=None), size=None)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sensor_frequency', django.contrib.postgres.fields.ArrayField(base_field=django.contrib.postgres.fields.ArrayField(base_field=models.FloatField(), size=None), blank=True, null=True, size=2)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(primary_key=True, serialize=False)),
                ('mark_title', models.CharField(blank=True, max_length=100)),
